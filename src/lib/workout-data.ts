import { Zap, Wind, Dumbbell, Shield, ArrowUp, ArrowDown, Footprints, User, Flame } from "lucide-react";
...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      { id: "pu1", name: "45° Incline Dumbbell Bench Press", sets: 3, reps: "8-10", targetMuscle: "Upper Chest" },
      { id: "pu2", name: "Dumbbell Lateral Raises", sets: 3, reps: "8-10", targetMuscle: "Side Delts", notes: "Rest 01 min between sets" },
      { id: "pu3", name: "15° Incline Dumbbell Bench Press", sets: 3, reps: "8-10", targetMuscle: "Upper Chest" },
      { id: "pu4", name: "Flat Dumbbell Flies", sets: 3, reps: "8-10", targetMuscle: "Chest", notes: "Keep in line with nipples / just above" },
      { id: "pu5", name: "X-Over Cable Tricep Extensions", sets: 3, reps: "8-10", targetMuscle: "Triceps" },
      { id: "pu6", name: "Single Arm Overhead Cable Tricep Extensions", sets: 3, reps: "8-10", targetMuscle: "Triceps" },
    ],
  },
  {
    id: "pull",
  ...
  },
  {
    ...
    exercises: [
      { id: "up1", name: "Seated Cable Row - V Bar", sets: 3, reps: "8-10", targetMuscle: "Mid Back" },
      { id: "up2", name: "Lat Pull Down - V Bar", sets: 3, reps: "8-10", targetMuscle: "Lats" },
      { id: "up3", name: "Flat Dumbbell Bench Press", sets: 3, reps: "8-10", targetMuscle: "Chest" },
      { id: "up4", name: "Cable Flies To Thighs", sets: 3, reps: "8-10", targetMuscle: "Lower Chest" },
      { id: "up5", name: "Converging Shoulder Press Machine", sets: 2, reps: "8-10", targetMuscle: "Shoulders" },
      { id: "up6", name: "Dumbbell Preacher Curls", sets: 3, reps: "8-10", targetMuscle: "Biceps" },
      { id: "up7", name: "Dumbbell Preacher Hammer Curls", sets: 2, reps: "8-10", targetMuscle: "Biceps" },
      { id: "up8", name: "Tricep Push Down - Rope", sets: 2, reps: "8-10", targetMuscle: "Triceps" },
    ],
  },
];
